...
import eari from "../../../../public/img/earingstop.jpg";
    ...
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "center", marginBottom: "3%" }}>
        <div style={{ position: "relative", width: "100%", height: "230px" }}>
          <Image src={eari} alt="Earings" fill style={{ objectFit: "cover" }} priority />
        </div>
      </div>
      ...
      >
        {loading ? (
          ...
          data.map((item, index) => (
            <div
              key={item._id || item.id || `earings-${index}`} // ✅ fixed key
              style={{
                flex:
                  windowWidth < 600
                    ? "1 0 100%"
